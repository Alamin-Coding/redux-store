    ...
    <div className="bg-white rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 overflow-hidden group">
      <div className="relative">
        ...
        <div className="absolute top-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity">
          {wishlistCard ? (
            <button onClick={()=> dispatch(removeWishlist(product.id))} className="bg-white p-2 rounded-full shadow-lg hover:bg-red-50 transition-colors cursor-pointer">
              <Trash2 className="h-4 w-4 text-gray-600 hover:text-red-500" />
            </button>
          ) : (
            <button onClick={()=> dispatch(addToWishlist(product))} className="bg-white p-2 rounded-full shadow-lg hover:bg-red-50 transition-colors cursor-pointer">
      ...
      <div className="p-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="bg-gradient-to-r from-purple-600 to-pink-600 text-white px-4 py-2 rounded-full hover:from-purple-700 hover:to-pink-700 transition-all duration-300 text-sm font-medium cursor-pointer"
          >
            Add To Cart
          </button>
        </div>
